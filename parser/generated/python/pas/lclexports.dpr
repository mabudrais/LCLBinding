...
Classes_TFindComponentClassEvent=procedure(Reader:treader;ClassName2:PChar;ComponentClass:tcomponentclass);cdecl;
...
procedure ClassesTFindComponentClassEvent_wrapper.call(Reader:TReader;const ClassName2:string;var ComponentClass:TComponentClass);
begin
C(treader(Reader),PChar(ClassName2),tcomponentclass(ComponentClass));
end;
