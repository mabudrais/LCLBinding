...
begin
Result:=Pointer(tform.create(tcomponent(theowner)));
end;
//Forms tform lclversion 842
procedure Forms_tform_lclversion_set(controlpointer:Pointer;p:string);cdecl;
begin
tform(controlpointer).lclversion:=string(p);
end;
//Forms tform lclversion 842
function Forms_tform_lclversion_get(controlpointer:Pointer):string;cdecl;
begin
Result:=string(tform(controlpointer).lclversion);
end;
//608
function Forms_tcustomform_create( aowner:Pointer):Pointer;cdecl;
begin
Result:=Pointer(tcustomform.create(tcomponent(aowner)));
end;
//609
function Forms_tcustomform_createnew( aowner:Pointer; num:Integer):Pointer;cdecl;
begin
Result:=Pointer(tcustomform.createnew(tcomponent(aowner),integer(num)));
end;
//Forms tcustomform active 671
function Forms_tcustomform_active_get(controlpointer:Pointer):boolean;cdecl;
begin
...
procedure Forms_tcustomform_allowdropfiles_set(controlpointer:Pointer;p:boolean);cdecl;
begin
tcustomform(controlpointer).allowdropfiles:=boolean(p);
end;
//Forms tcustomform allowdropfiles 674
function Forms_tcustomform_allowdropfiles_get(controlpointer:Pointer):boolean;cdecl;
begin
Result:=boolean(tcustomform(controlpointer).allowdropfiles);
end;
//Forms tcustomform alphablend 675
procedure Forms_tcustomform_alphablend_set(controlpointer:Pointer;p:boolean);cdecl;
begin
tcustomform(controlpointer).alphablend:=boolean(p);
end;
//Forms tcustomform alphablend 675
function Forms_tcustomform_alphablend_get(controlpointer:Pointer):boolean;cdecl;
begin
...
procedure Forms_tcustomform_helpfile_set(controlpointer:Pointer;p:string);cdecl;
begin
tcustomform(controlpointer).helpfile:=string(p);
end;
//Forms tcustomform helpfile 693
function Forms_tcustomform_helpfile_get(controlpointer:Pointer):string;cdecl;
begin
Result:=string(tcustomform(controlpointer).helpfile);
end;
...
procedure Forms_tcustomform_keypreview_set(controlpointer:Pointer;p:boolean);cdecl;
begin
tcustomform(controlpointer).keypreview:=boolean(p);
end;
//Forms tcustomform keypreview 695
function Forms_tcustomform_keypreview_get(controlpointer:Pointer):boolean;cdecl;
begin
...
begin
Result:=Pointer(tcustomdesigncontrol.create(tcomponent(theowner)));
end;
...
procedure Forms_tcustomdesigncontrol_scaled_set(controlpointer:Pointer;p:boolean);cdecl;
begin
tcustomdesigncontrol(controlpointer).scaled:=boolean(p);
end;
//Forms tcustomdesigncontrol scaled 278
function Forms_tcustomdesigncontrol_scaled_get(controlpointer:Pointer):boolean;cdecl;
begin
...
begin
Result:=Pointer(tscrollingwincontrol.create(tcomponent(theowner)));
end;
